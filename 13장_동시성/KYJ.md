...
이 장에서는 여러 스레드를 동시에 돌리는 어려움을 논하고 이런 어려움에 대처하여 깨끗한 코드를 작성하는 방법을 제안한다.  
또한 동시성을 테스트하는 방법과 문제점을 논한다._   
<br>
<hr/>
...
- _연결 서버 - 잠금을 수행하는 중간 단계를 생성한다. '서버에서 잠금' 방식과 유사하지만 원래 서버는 변경하지 않는다._  
  <br>
<hr/>
